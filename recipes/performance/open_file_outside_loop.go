...
func (v *openFileOutsideLoopVisitor) VisitForLoop(forLoop *java.ForLoop, p any) java.J {
	v.insideLoop++
...
func (v *openFileOutsideLoopVisitor) VisitForEachLoop(forEach *java.ForEachLoop, p any) java.J {
	v.insideLoop++
...
func (v *openFileOutsideLoopVisitor) VisitMethodInvocation(mi *java.MethodInvocation, p any) java.J {
