...
func (v *avoidContextWithValueVisitor) VisitMethodInvocation(mi *tree.MethodInvocation, p any) tree.J {
	...
	mi = mi.WithMarkers(tree.MarkupInfo(mi.Markers, "context.WithValue() call; consider passing dependencies explicitly"))
	return mi
}
