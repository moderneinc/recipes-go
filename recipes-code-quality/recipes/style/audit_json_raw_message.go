...
func (v *auditJsonRawMessageVisitor) VisitFieldAccess(fa *tree.FieldAccess, p any) tree.J {
	...
	fa = fa.WithMarkers(tree.MarkupInfo(fa.Markers, "json.RawMessage defers parsing; review for correctness"))
	return fa
}
