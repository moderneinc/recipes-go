...
**208 recipes** across 7 categories with **720 tests**.
...
| **Migration** | 20 | Go version and go.mod upgrades, encoding/json/v2 migration scoping and rewrites |
